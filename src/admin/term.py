...
class TermView(SecureModelView):
    ...
    column_labels = {"subject": "მიმართულება", "eng_word": "სიტყვა eng", "geo_word": "სიტყვა ქართ",
                     "description": "განმარტება", "parent_word_rel": "მშობელი ტერმინი", "example": "მაგალითი"}
    ...
    form_args = {"img": {"label": "სურათის ატვირთვა",
                         "base_path": path.dirname("src/static/uploads"),
